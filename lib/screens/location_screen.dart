  ...
  void updateUI(dynamic weatherData) {
    setState(() {
      if (weatherData == null) {
        temp = 0;
        weatherIcon = "ERROR";
        statement = "Unable to fetch Location";
        city = "";
        return;
      }
      ...
      statement = weatherModel.getMessage(temp);
      pressure = weatherData['main']['pressure'].toInt();
      humidity = weatherData['main']['humidity'].toInt();
      min_temp = weatherData['main']['temp_min'].toInt();
      max_temp = weatherData['main']['temp_max'].toInt();
    });
  }
  String img;
  void dayNight(){
